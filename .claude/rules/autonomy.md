...
- `/phase` 실행 시 자율 모드 시작. 아래 "자율 허용" 항목을 확인 없이 수행한다.
- phase 종료, 에스컬레이션 발생, 또는 사용자 개입 시 자율 모드를 종료하고 사용자 확인 모드로 전환한다.
- 단순 작업(phase 없이 진행)에서는 사용자 요청 단위로 자율 실행하고, 각 요청 완료 시 보고한다.

## 자율 허용

- phase 실행 중 커밋 (commits.md Autonomy 참조)
- feature 브랜치 생성
